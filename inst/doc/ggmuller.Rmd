...
Since simulations can result in very large sets of genotypes, many of which never become abundant, `get_Muller_df` has a threshold option to exclude rarities:
