...
You can change the `Muller_plot` or `Muller_pop_plot` axis labels using the options `xlab` and `ylab`. Further plot customisation is possible only by replacing `Muller_plot` or `Muller_pop_plot` with your own ggplot wrapper.
