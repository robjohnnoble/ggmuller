...
If some of your genotype populations go extinct then you  might see blank segments in the plot. Using `get_Muller_df` with the option `smooth_start_points = TRUE` should remedy this problem.
